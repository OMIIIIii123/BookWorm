...
public class LibraryServiceImpl implements LibraryService {
    ...
    public void selectBookFromLibrary(Integer userId, Integer productId) {
        ...
        UserLibrarySubscription subscription =
                subscriptionRepository.findByCustomerAndActiveTrue(customer);
        ...
        if (subscription.getBooksSelectedCount()
        ...
        boolean allowed =
                libraryPackageProductRepository
        ...
        boolean alreadySelected =
                libraryBookRepository.existsByCustomerAndProductAndSubscription(
